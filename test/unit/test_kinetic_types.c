...
void test_Kinetic_GetStatusDescription_should_return_appropriate_descriptions(void)
{
    ...
    TEST_ASSERT_EQUAL_STRING("NO_PDUS_AVAVILABLE", Kinetic_GetStatusDescription(KINETIC_STATUS_NO_PDUS_AVAVILABLE));
    ...
    TEST_ASSERT_EQUAL_STRING("SESSION_TERMINATED", Kinetic_GetStatusDescription(KINTEIC_STATUS_SESSION_TERMINATED));
}
