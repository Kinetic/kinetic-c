...
void test_KineticACL_LoadFromFile_ex1_should_parse_file_as_expected(void)
{
    ...
    Com_Seagate_Kinetic_Proto_Command_Security_ACL *acl = acls->ACLs[0];

    TEST_ASSERT_TRUE(acl->has_identity);
    TEST_ASSERT_EQUAL(1, acl->identity);

    TEST_ASSERT_TRUE(acl->has_hmacAlgorithm);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_HMACALGORITHM_HmacSHA1,
        acl->hmacAlgorithm);
    ...
    Com_Seagate_Kinetic_Proto_Command_Security_ACL_Scope *sc0 = acl->scope[0];
    TEST_ASSERT_EQUAL(1, sc0->n_permission);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_READ,
        sc0->permission[0]);

    Com_Seagate_Kinetic_Proto_Command_Security_ACL_Scope *sc1 = acl->scope[1];
    TEST_ASSERT_TRUE(sc1->has_offset);
    TEST_ASSERT_EQUAL(0, sc1->offset);
    TEST_ASSERT_EQUAL(1, sc1->n_permission);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_WRITE,
        sc1->permission[0]);
...
void test_KineticACL_LoadFromFile_ex2_should_parse_file_as_expected(void)
{
    ...
    Com_Seagate_Kinetic_Proto_Command_Security_ACL_Scope *sc0 = acl->scope[0];
    TEST_ASSERT_EQUAL(1, sc0->n_permission);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_SECURITY,
        sc0->permission[0]);
...
void test_KineticACL_LoadFromFile_should_recognize_all_permission_types(void)
{
    ...
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_DELETE,
        acl->scope[2]->permission[0]);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_RANGE,
        acl->scope[3]->permission[0]);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_SETUP,
        acl->scope[4]->permission[0]);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_P2POP,
        acl->scope[5]->permission[0]);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_GETLOG,
...
void test_KineticACL_LoadFromFile_should_handle_multiple_permissions(void)
{
    ...
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_READ, acl->scope[0]->permission[0]);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_WRITE, acl->scope[0]->permission[1]);
    TEST_ASSERT_EQUAL(COM_SEAGATE_KINETIC_PROTO_COMMAND_SECURITY_ACL_PERMISSION_SETUP, acl->scope[0]->permission[2]);
...
void test_acl_should_handle_multiple_JSON_objects(void)
{
    ...
    Com_Seagate_Kinetic_Proto_Command_Security_ACL *acl2 = acls->ACLs[1];
