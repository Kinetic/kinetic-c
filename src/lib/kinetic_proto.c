...
static const ProtobufCFieldDescriptor KineticProto_get_log_limits__field_descriptors[9] =
{
  {
    "maxKeySize",
    1,
...
const ProtobufCEnumValue KineticProto_get_log_type__enum_values_by_number[8] =
{
...
const ProtobufCEnumValueIndex KineticProto_get_log_type__enum_values_by_name[8] =
{
  { "CAPACITIES", 3 },
  { "CONFIGURATION", 4 },
  { "INVALID_TYPE", 0 },
