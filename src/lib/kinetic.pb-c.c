...
char com__seagate__kinetic__proto__local__protocol_version__default_value[] = "3.0.7";
...
const ProtobufCEnumValue com__seagate__kinetic__proto__command__status__status_code__enum_values_by_number[24] =
{
  ...
  { "DRIVE_POWER_DOWN", "COM__SEAGATE__KINETIC__PROTO__COMMAND__STATUS__STATUS_CODE__DRIVE_POWER_DOWN", 22 },
};
static const ProtobufCIntRange com__seagate__kinetic__proto__command__status__status_code__value_ranges[] = {
{-1, 0},{0, 24}
};
const ProtobufCEnumValueIndex com__seagate__kinetic__proto__command__status__status_code__enum_values_by_name[24] =
{
...
static const ProtobufCFieldDescriptor com__seagate__kinetic__proto__command__setup__field_descriptors[3] =
{
  {
    "newClusterVersion",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BOOL,
    offsetof(Com__Seagate__Kinetic__Proto__Command__Setup, has_drivepowerdown),
    offsetof(Com__Seagate__Kinetic__Proto__Command__Setup, drivepowerdown),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCFieldDescriptor com__seagate__kinetic__proto__command__get_log__limits__field_descriptors[13] =
{
  ...
  {
    "maxBatchCountPerConnection",
    13,
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    offsetof(Com__Seagate__Kinetic__Proto__Command__GetLog__Limits, has_maxbatchcountperconnection),
    offsetof(Com__Seagate__Kinetic__Proto__Command__GetLog__Limits, maxbatchcountperconnection),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned com__seagate__kinetic__proto__command__get_log__limits__field_indices_by_name[] = {
  12,   /* field[12] = maxBatchCountPerConnection */
